...
class PatientSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = Patient
        fields = ('first_name', 'last_name', 'display_name', 'legalGuardiant', 'address', 'socialSecurityNumber')
...
class CostApprovalSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = CostApproval
        fields = ('name', 'costApprovalType', 'patient', 'insurance', 'cost', 'status', 'startDate', 'EndDate', 'invoiceDate', 'paymentDate')
